...
var Buffer, Caret, Indent, Stack, fs, match, parse, path, print, tokenize, type, wrap_parse, _ref,
  __slice = [].slice;
...
_ref = require('./states'), Caret = _ref.Caret, Buffer = _ref.Buffer, Stack = _ref.Stack, Indent = _ref.Indent;
...
tokenize = function(text) {
  var buffer, caret, indent, pushStack, pushTokens, stack, tokens;
  caret = new Caret;
  buffer = new Buffer;
  stack = new Stack;
  indent = new Indent;
